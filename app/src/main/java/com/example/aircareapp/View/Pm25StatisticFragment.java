...
public class Pm25StatisticFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_pm25_statistic, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        plot = (XYPlot) view.findViewById(R.id.plot5);
        handleSSLHandshake();
        ...
        XYSeries series1 = new SimpleXYSeries(
                pm25, SimpleXYSeries.ArrayFormat.Y_VALS_ONLY, "PM25 (µg/m³)");
